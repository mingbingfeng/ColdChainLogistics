...
namespace C2LP.PDA.APP
{
    public partial class UCNodeList : UserControl
    {
        ...
        private void pnlNodeList_GotFocus(object sender, EventArgs e)
        {
            FrmParent.ParentForm.ResetReturnDelay();
        }

        private void pnlNodeList_LostFocus(object sender, EventArgs e)
        {
            FrmParent.ParentForm.ResetReturnDelay();
        }

        private void pnlNodeList_Click(object sender, EventArgs e)
        {
            FrmParent.ParentForm.ResetReturnDelay();
        }
        ...
        private void UCNodeList_Click(object sender, EventArgs e)
        {
            FrmParent.ParentForm.ResetReturnDelay();
        }

        private void UCNodeList_LostFocus(object sender, EventArgs e)
        {
            FrmParent.ParentForm.ResetReturnDelay();
        }
    }
