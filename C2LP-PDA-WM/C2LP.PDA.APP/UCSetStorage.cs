...
namespace C2LP.PDA.APP
{
    public partial class UCSetStorage : UserControl
    {
        ...
        private void UCSetStorage_Click(object sender, EventArgs e)
        {
           FrmParent.ParentForm.ResetReturnDelay();
        }

        private void cboStorage_GotFocus(object sender, EventArgs e)
        {
           FrmParent.ParentForm.ResetReturnDelay();
        }

        private void cboStorage_LostFocus(object sender, EventArgs e)
        {
           FrmParent.ParentForm.ResetReturnDelay();
        }
