...
namespace C2LP.PDA.APP
{
    public partial class UCMain : UserControl
    {
        ...
        public void RemoeveControlEvent()
        {
            ...
            btnCenterNode.Click -= new EventHandler(btnCenterNode_Click);
        }
        ...
        void btnCenterNode_Click(object sender, EventArgs e)
        {
            FrmParent.ParentForm.OpenForm(PageState.CenterNode);
        }
        ...
        public void SetSyncInfo(string msg) {
