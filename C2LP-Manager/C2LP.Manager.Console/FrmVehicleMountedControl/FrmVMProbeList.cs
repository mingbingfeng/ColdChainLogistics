...
{
    public partial class FrmVMProbeList : Form
    {
        ConsoleServerWebReference.ConsoleServer cs = new ConsoleServerWebReference.ConsoleServer();
        public Model_ColdstoragePDA mcp;
        public FrmVMProbeList()
        {
            InitializeComponent();
        }

        private void FrmVMProbeList_Load(object sender, EventArgs e)
        {
            lbCarNumber.Text="【"+mcp.StorageNamek__BackingField+"】探头列表";
            getProbe();
        ...
        private void tsmEdit_Click(object sender, EventArgs e)
        {
            ...
            FrmVMProbeEdit eidt = new FrmVMProbeEdit();
            eidt.mai = mai;
            eidt._ParentVMP = this;
            eidt.ShowDialog();
        }
