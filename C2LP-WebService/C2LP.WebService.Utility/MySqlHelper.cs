...
namespace C2LP.WebService.Utility
{
    ...
    public sealed partial class MySqlHelper
    {
        ...
        //private static MySqlConnection _cn = null;
        ...
        /// <returns></returns>
        public bool ExecuteTranstration(List<string> sqlList) {
            return ExecuteTranstration(ConnectionString, sqlList);
        }
        /// <summary>
        ...
        /// <param name="sqlList">sql语句集合</param>
        /// <returns></returns>
        public static bool ExecuteTranstration(string connectionString, List<string> sqlList) {
            MySqlConnection connection = new MySqlConnection(connectionString);
