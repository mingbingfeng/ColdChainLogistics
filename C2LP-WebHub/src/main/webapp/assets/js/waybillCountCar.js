...
WaybillCount.prototype.queryButton = function() {
    ...
    if(!beginAt || !signinAt) {
        ...
        NProgress.start();
        window.location.href = URLHelper.waybillCountCarUrl(beginAt,signinAt)+"&carId="+carId;
    }
}
...
WaybillCount.prototype.getpdf = function() {
    ...
    if(!beginAt || !signinAt) {
        ...
        window.open(URLHelper.waybillCountCarPDFUrl(beginAt,signinAt)+"&carId="+carId);
    }
}
