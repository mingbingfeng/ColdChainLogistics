 ...
 */
var ZheXianDataPicture = function() {
    this.init();
}

ZheXianDataPicture.prototype.init = function () {
    this.onloadpicture();
}

ZheXianDataPicture.prototype.onloadpicture = function () {
    URLHelper.ajax({
        'url': URLHelper.zhexiandatapictureUrl(),
        'method': 'GET',
        'data': {
            'number': $("#number").val(),
