...
<html>
                ...
                <div class="col-lg-10 col-md-9">
                    ...
                    <c:if test="${ not empty waybillBase}">
                        ...
                        <c:if test="${waybillBase.stage==1}">
                            <div class="alert alert-danger" id = "arrived" style="text-align: center;">当前运单已运达！</div>
                        </c:if>
                        <c:if test="${waybillBase.stage==0}">
                            <div id="bottom" data-starttimee ="first" data-nodeId ="first">
                                <div class="alert alert-danger alert-none"  style="text-align: center;display: none;">
                                    未查找到当前节点的最新数据，请稍后。
                                </div>
    ...
    <script type="text/javascript" src="/assets/js/TruckRealMap.js"></script>
