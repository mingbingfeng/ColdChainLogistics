...
{
    class SyncNodeDataUpload_New
    {
        SyncNodeDataUpload_New()
        {
        ...
        static SyncNodeDataUpload_New _Instance;
        /// <summary>
        /// 单例实例
        /// </summary>
        public static SyncNodeDataUpload_New Instance
        {
            get
            {
                if (_Instance == null)
                    _Instance = new SyncNodeDataUpload_New();
                return _Instance;
            }
        }
        ...
        {
            int interval;
            if (!int.TryParse(Utility._SyncNodeDataUploadInterval_New, out interval) || interval == 0)
                interval = 3;
